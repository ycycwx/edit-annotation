...
app.controller("EditController", [ '$scope', '$http', '$cookies', '$cookieStore', function ($scope, $http, $cookies, $cookieStore) {
    ...
    $scope.file     = $scope.selected['name'];
...
document.getElementById("uploadSubmit").onclick = function () {
    var us = document.getElementById("uploadFile");
    if (us.value === "") {
